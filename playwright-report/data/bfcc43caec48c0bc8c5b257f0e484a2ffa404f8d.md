...
- Name: extension.spec.ts >> VaultGuard Gold Release E2E Suite >> Security: Hidden field attack mitigation
- Location: e2e/extension.spec.ts:74:3
...
Call log:
  ...
  - waiting for locator('input[name="username"]')
    14 × locator resolved to <input type="text" name="username" class="hidden-field" autocomplete="username"/>
